...
public class Okul {
//TODO
// Ogrenci ve Calisanlar okula kayıt yapılacağından kayıt işlemi Okul sınıfının içerisinde olmalı,
// bu yüzden ArrayList ler ve kayıt işlemi Okul sınıfın içine yazıldı.
